...
// Delete At a given position using Array Implementation in Stack
...
void deleteAtPos(Stack, int);                    // Use to delete at a given position
...
void deleteAtPos(Stack S, int pos)
{
    // Validate position
    if(!empty(S) && pos >= 0 && pos <= S->top) {
        // Shift elements
